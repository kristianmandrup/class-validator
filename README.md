...
## Adding Validators directly (without decorators)

There is now experimental support for adding validators directly to class fields without using decorators. See the functions exported in `src/constraints`
